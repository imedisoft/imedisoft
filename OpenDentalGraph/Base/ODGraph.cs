...
namespace OpenDentalGraph
{
	...
	{
		/// <summary>
		/// Static variable that increments every time a new instance of this class is created.
		/// </summary>
		private static long _idCounter;

		/// <summary>
		/// Unique ID for this legend item.
		/// </summary>
		public long ID { get; private set; }

		/// <summary>
		/// SeriesName that shows in the legend.
		/// </summary>
		public string ItemName { get; set; }

		/// <summary>
		/// Color associated to this legend item.
		/// </summary>
		public Color ItemColor { get; set; }

		/// <summary>
		/// Tells the control whether or not to grey this item out and temporarily exclude it from the graph.
		/// </summary>
		public bool IsEnabled { get; set; }

		/// <summary>
		/// The location of the colored box indicating this legendItem's color.
		...
		/// <summary>
		/// For ordering. The value associated to this legendItem. 
		/// This is set to the sum of the values for all the points associated to this series.
		/// </summary>
		public double Val { get; set; }

		/// <summary>
		/// Tells the control whether or not to show the background hovered box.
		/// </summary>
		public bool Hovered { get; set; }

		/// <summary>
		/// Delegate for filtering the legend when the user clicks.
		/// </summary>
		...
		/// <summary>
		/// Called to filter the legend and chart when the user disables or re-enables this legendItem.
		/// </summary>
		public void Filter() => OnFilterLegend?.Invoke(this);


		/// <summary>
		/// Constructor, increments the ID counter.
		/// </summary>
	...
	/// <summary>
	/// Wraps JSON serialization. Any class that extends this class should NEVER change variable names after being released. 
	...
	public class ODGraphSettingsBase
	{
		...
		/// <summary>
		/// Helper property to give easy access to the current DashboardFilter settings for this graph.
		/// </summary>
		public Cache.DashboardFilter Filter
			=> new Cache.DashboardFilter()
			{
				DateTo = DateTo,
				DateFrom = DateFrom,
				UseDateFilter = QuickRangePref != Enumerations.QuickRange.allTime
			};


		/// <summary>
		/// Helper method to convert from json string to ODGraphBaseSettingsAbs.
		/// Most importantly, provides filter settings for a given DashboardCell.
		/// </summary>
		...
		/// <summary>
		/// If quickRange==QuickRange.custom then return a filter containing customDateFrom and customDateTo. 
		/// In all other cases, the date range will be calculated given the quickRange.
		/// </summary>
	...
	/// <summary>
	/// Wrapper class which allows for 2 json fields. 1 for the graph and 1 for the filter.
	/// </summary>
	public class ODGraphJson
	{
		...
		public static ODGraphJson Deserialize(string json) 
			=> JsonConvert.DeserializeObject<ODGraphJson>(json);
	}
}
...
namespace OpenDentalGraph.Enumerations
{
	...
	{
		/// <summary>
		/// Show every series as it's own series. Do not group.
		/// </summary>
		all,

		/// <summary>
		/// Show only 1 series as the group of all series combined.
		/// </summary>
		none,

		/// <summary>
		/// Show top x items each in their own series where x is defined by BreakdownVal.
		/// All remaining series will be grouped as one series.
		/// </summary>
		items,

		/// <summary>
		/// Show top x percentage of items each in their own series where x is defined by BreakdownVal.
		/// All remaining series will be grouped as one series.
		/// </summary>
		percent
	}

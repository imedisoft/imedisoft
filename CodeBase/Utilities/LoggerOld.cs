...
namespace CodeBase
{
    public partial class Logger
	{
		...
		public bool Log(string message, Severity severity) 
			=> Log(null, "", message, false, severity);
		...
		/// <summary>
		/// Log a message to the log text file and add a description of the sender (for debugging purposes).
		/// If sender is null then a description of the sender is not printed.
		/// Always returns false so that a calling boolean function can return at the same time that it logs an error message.
		/// </summary>

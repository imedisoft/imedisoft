...
namespace CodeBase
{
	public class DateSpan
	{
		...
		private void GetYears(DateTime startDate, DateTime endDate)
		{
			...
			YearsDiff = years - 1;//Subtract 1 to always round down to the nearest year, since partial years are covered by months and days.
		}
		...
		private void GetMonths(DateTime startDate, DateTime endDate)
		{
			...
			MonthsDiff = months - 1;//Subtract 1 to always round down to the nearest month, since partial months are covered by days.
		}
		...
		private void GetDays(DateTime startDate, DateTime endDate)
		{
			...
			DaysDiff = days;//Do not subtract 1 (always round up) since days are the smallest increment of time used.
		}
	}
}

...
{
	/// <summary>
	/// This class can be used over Middle Tier in place of System.Tuple. 
	/// Trying to serialize a System.Tuple for Middle Tier will cause an exception because it does not have a parameterless constructor.
	///</summary>

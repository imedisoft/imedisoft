...
namespace CodeBase
{
    public static class MiscUtils
	{
		...
		/// <summary>
		/// Returns exception string that includes the threadName if provided and exception type and up to 5 inner exceptions.
		/// Used for both bugSubmissions and the MsgBoxCopyPaste shown to customers when a UE occurs.
		/// </summary>
		public static string GetExceptionText(Exception e, string threadName = null)
		{
			...
			{
				foreach (Exception innerEx in exception.InnerExceptions)
				{
			...
			{
				text += InnerExceptionToString(e.InnerException);
			}
		...
		/// <summary>
		/// Formats the inner exception (and all its inner exceptions) as a readable string.
		/// Okay to pass in an exception with no inner exception.
		/// </summary>
		...
		/// <summary>
		/// Gets the innermost InnerException that is not null. Recursive.
		/// </summary>
		...
		/// <summary>
		/// Returns the exception or inner exception that contains the given message.
		...
		/// <summary>
		/// Gets the ordinal indicator e.g.passing in 13 will return "th".
		...
		/// <summary>
		/// Gets the most recent date in the past (or today) that is the specified day of week.
		/// </summary>
		...
		/// <summary>
		/// Gets the soonest upcoming date in the future (or today) that is the specified day of week.
		/// </summary>
		...
		/// <summary>
		/// Finds installed IE version for this workstation and attempts to modify registry to force browser emualtion to this version.
		...
		/// If true is returned than this application will need to be restarted in order for the changes to take effect.
		/// </summary>
	...
	/// <summary>
	/// This class is used to create a tree of actions who depend on each other.
	...
	public class ActionNode
	{
		...
		/// <summary>
		/// Creates an action node with children via the parameters passed in.
		/// </summary>
		...
		/// <summary>
		/// Synchronously invokes _actionParent on the main thread then asynchronously invokes all _listChildActionNodes (run in parallel)
		/// and then waits until all children and their children's children (utilizing recursion) have finished executing.
		/// </summary>
	...
	/// This class syncronizes a single instance of System.Random and performs a lock anytime it is accessed, which makes it thread-safe.
	/// </summary>
	public static class ODRandom
	{
		...
		/// <summary>
		/// Returns a random integer that is within a specified range. minValue is inclusive, maxValue is exclusive. 
		/// System.Random is not thread-safe. 
		/// This method makes it thread-safe.
		/// </summary>

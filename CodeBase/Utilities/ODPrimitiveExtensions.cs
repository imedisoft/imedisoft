...
namespace CodeBase {
	public static class ODPrimitiveExtensions {
		///<summary>Used to check if a decimal number is "equal" to zero based on some epsilon. 
		/// Epsilon is 0.0000001M and will return true if the absolute value of the decimal is less than that.</summary>

...
{
	/// <summary>
	/// A wrapper for FormProgressExtended.
	/// </summary>
	public class ODProgressExtended : IODProgressExtended
	{
		...
		///</param>
		public ODProgressExtended(EventCategory odEventType, IODEvent odEvent, Form currentForm, object tag = null, ProgBarStyle progBarStyle = ProgBarStyle.Blocks,
		...
		public void Fire(EventCategory odEventType, object tag)
		{
		...
		/// <summary>
		/// Checks if progress is paused and waits if it is. If progress gets canceled (while paused or not) returns true
		/// </summary>

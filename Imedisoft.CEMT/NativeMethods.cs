...
namespace CentralManager
{
	...
	/// <summary>
	/// In the Win API, these constants are used in showCmd. Used in ShowWindow and GetWindowPlacement.
	/// </summary>
	public enum ShowState : int
	{
		...
		/// <summary>
		/// Similar to SW_SHOWMINIMIZED, except not activated.
		/// </summary>
		SW_SHOWMINNOACTIVE = 7,

		/// <summary>
		/// Similar to SW_SHOW, except not activated.
		/// </summary>
		SW_SHOWNA = 8,

		/// <summary>
		/// Use this to restore a minimized window. (except we might want to "restore" to max)
		/// </summary>
		SW_RESTORE = 9
	}
}

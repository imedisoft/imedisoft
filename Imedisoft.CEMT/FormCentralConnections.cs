...
namespace CentralManager
{
	public partial class FormCentralConnections : Form
	{
		...
		private void gridMain_CellDoubleClick(object sender, ODGridClickEventArgs e)
		{
			...
			FormCentralConnectionEdit FormCCE = new FormCentralConnectionEdit(_listConnsShowing[e.Row]);
			FormCCE.ShowDialog();
			_listConnsAll = CentralConnections.GetConnections();
			FillGrid();
		}
		...
		private void butAdd_Click(object sender, EventArgs e)
		{
			...
			conn.IsNew = true;
			FormCentralConnectionEdit FormCCE = new FormCentralConnectionEdit(conn);

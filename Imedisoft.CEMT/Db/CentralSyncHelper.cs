...
namespace CentralManager
{
	public static class CentralSyncHelper
	{
		...
		/// <summary>
		/// When sync is performed, this dictionary will contain the CentralConnectionNum and the error message, if there is one.
		/// </summary>
		...
		/// <summary>
		/// Function used by threads to connect to remote databases and sync user settings.
		/// </summary>
		...
		/// <summary>
		/// Custom data structure for containing a UserGroup and its associated list of GroupPermissions and users.
		/// </summary>

...
namespace CentralManager
{
	...
	{
		/// <summary>
		/// Syncs the database to reflect what is contained within listNew.
		/// Returns a list of UserGroups that need to be deleted as Users need to be moved out of the group before they can be deleted.
		/// Compares entries based on UserGroupNumCEMT rather than primary keys.
		/// </summary>

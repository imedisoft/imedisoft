...
namespace Imedisoft.Data.Models
{
	...
	public class Provider
	{
		...
		/// <summary>
		/// True if the SSN field is actually a Tax ID number.
		/// </summary>
		[Column("using_tin")]
		public bool UsingTIN;

		/// <summary>
		/// The DEA number for this provider.
		/// </summary>
		[Nullable]
		...
		/// <summary>
		///		<para>
		///			Required field for e-Claims in Canada. Assigned by CDA.
		///		</para>
		///		<para>
		...
		/// <summary>
		/// Used to determine which stage of MU the provider is shown. 0=Global preference(Default), 1=Stage 1, 2=Stage 2, 3=Modified Stage 2.
		/// </summary>
		public int EhrMuStage;

		[ForeignKey(typeof(Provider), nameof(Id))]
		...
		/// <summary>
		/// The description of the provider that is displayed to patients in Web Sched.
		/// </summary>
		public string WebSchedDescription;

		/// <summary>
		/// The image of the provider that is displayed to patients in Web Sched. File name only (path not included).
		/// This should be a file name in the A to Z folder.
		/// </summary>
		...
		public string GetLongDesc()
		{
			...
			var name = $"[{Abbr}] {LastName}, {FirstName}";

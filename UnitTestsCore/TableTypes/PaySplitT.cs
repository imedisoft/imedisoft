...
namespace UnitTestsCore {
	public class PaySplitT {
		...
		public static PaySplit CreateOne(long patNum,double splitAmt,long payNum,long provNum,DateTime procDate=default,long procNum=0,
			long clinicNum=0,long payplanNum=0,long unearnedType=0,long adjNum=0,long fSplitNum=0)
		{
			return CreateSplit(clinicNum,patNum,payNum,payplanNum,procDate,procNum,provNum,splitAmt,unearnedType,adjNum,fSplitNum);
		}

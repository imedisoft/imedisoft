...
namespace OpenDentBusiness {
	public class GraphicsHelper {
		...
		///<param name="rectangleF">A System.Drawing.RectangleF structure that represents the rectangle to draw.</param>
		///<param name="round">Determines the radius of the corners.</param>
		public static void DrawRoundedRectangle(Graphics g,Pen pen,RectangleF rectangleF,float round) {
			//Keep track of what the SmoothingMode was before this method was invoked.
			SmoothingMode oldSmoothingMode=g.SmoothingMode;
			g.SmoothingMode=SmoothingMode.AntiAlias;
			//top,right
			g.DrawLine(pen,rectangleF.Left+round,rectangleF.Top,rectangleF.Right-round,rectangleF.Top);
			g.DrawArc(pen,rectangleF.Right-round*2,rectangleF.Top,round*2,round*2,270,90);
			//right,bottom
			g.DrawLine(pen,rectangleF.Right,rectangleF.Top+round,rectangleF.Right,rectangleF.Bottom-round);
			g.DrawArc(pen,rectangleF.Right-round*2,rectangleF.Bottom-round*2,round*2,round*2,0,90);
			//bottom,left
			g.DrawLine(pen,rectangleF.Right-round,rectangleF.Bottom,rectangleF.Left+round,rectangleF.Bottom);
			g.DrawArc(pen,rectangleF.Left,rectangleF.Bottom-round*2,round*2,round*2,90,90);
			//left,top
			g.DrawLine(pen,rectangleF.Left,rectangleF.Bottom-round,rectangleF.Left,rectangleF.Top+round);
			g.DrawArc(pen,rectangleF.Left,rectangleF.Top,round*2,round*2,180,90);

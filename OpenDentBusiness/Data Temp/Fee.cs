...
{
	/// <summary>
	/// There is one entry in this table for each fee for a single procedurecode. 
	/// So if there are 5 different fees stored for one procedurecode, then there will be five entries here.
	/// </summary>
	[Table("fees")]

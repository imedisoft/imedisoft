...
namespace OpenDentBusiness
{
	...
	public class X835 : X12object
	{
		...
		public X835(Etrans etransSource, string messageText, string tranSetId, List<Etrans835Attach> listAttached = null, bool isSimple = false) : base(messageText)
		...
		private void DiscoverSplitClaims()
		{
			foreach (Hx835_Claim claim in ListClaimsPaid)
			{
				...
				if (!string.IsNullOrWhiteSpace(claim.PayerControlNumber))
				{

...
{
    /// <summary>
    /// Encapsulates one entire X12 Interchange object, including multiple functional groups and transaction sets. 
    /// It does not care what type of transactions are contained.  It just stores them. 
    /// It does not inherit either. It is up to other classes to use this as needed.
    /// </summary>

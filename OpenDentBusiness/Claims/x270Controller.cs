...
namespace OpenDentBusiness.Eclaims
{
	...
	public class x270Controller
	{
		...
		public static Etrans RequestBenefits(Clearinghouse clearinghouseClin, InsurancePlan plan, long patNum, Carrier carrier, InsSub insSub, out string error)
		{
			...
			Provider billProv = Providers.GetById(Providers.GetBillingProviderId(pat.PriProv, pat.ClinicNum));
			...
			etrans.ClearingHouseNum = clearinghouseClin.Id;
			...
			etrans271.ClearingHouseNum = clearinghouseClin.Id;

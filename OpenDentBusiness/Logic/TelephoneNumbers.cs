...
namespace OpenDentBusiness
{
	public class TelephoneNumbers
	{
		...
		/// <summary>
		/// Also truncates if more than two non-numbers in a row.
		/// This is to avoid the notes that can follow phone numbers.
		/// </summary>
		public static string FormatNumbersOnly(string phoneStr)
		{
			...
			{
				if (nonnumcount == 2) return retVal;
		...
		public static string FormatNumbersExactTen(string phoneNum)
		{
			...
			for (int i = 0; i < phoneNum.Length; i++)
			{
				...
				if (retVal.Length == 10) return retVal;
			}

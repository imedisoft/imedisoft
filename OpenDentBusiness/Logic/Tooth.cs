...
namespace OpenDentBusiness
{
	public class Tooth
	{
		...
		{
			return GetToothLabel(tooth_id, (ToothNumberingNomenclature)PrefC.GetInt(PreferenceName.UseInternationalToothNumbers));
		}
		...
		{
			return GetToothLabelGraphic(tooth_id, (ToothNumberingNomenclature)PrefC.GetInt(PreferenceName.UseInternationalToothNumbers));
		}
		...
		{
			ToothNumberingNomenclature nomenclature = (ToothNumberingNomenclature)PrefC.GetInt(PreferenceName.UseInternationalToothNumbers);
		...
		{ // CWI: Left for compatibility
			return ToInternat(toothNum, (ToothNumberingNomenclature)PrefC.GetInt(PreferenceName.UseInternationalToothNumbers));
		}
		...
		{
			int nomenclature = PrefC.GetInt(PreferenceName.UseInternationalToothNumbers);
			if (nomenclature == 0)
			{//Universal,american

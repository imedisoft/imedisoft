...
namespace OpenDentBusiness
{
	...
	{
		/// <summary>
		/// Takes a ProcedureCode and returns the given arch for that code based on ADA standards.
		/// Returns "U" by default, an empty string for Canada, "U" for Maxillary codes and "L" for Mandibular codes.
		/// </summary>

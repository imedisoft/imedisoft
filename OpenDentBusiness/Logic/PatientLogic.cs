...
namespace OpenDentBusiness
{
    public class PatientLogic
	{
		...
		public static string GetNameLF(string lastName, string firstName, string preferredName, string middleInitial)
		{
			...
			return lastName + ", '" + preferredName + "' " + firstName + " " + middleInitial;
		}

		/// <summary>
		/// Converts a date to an age. Blank if over 115. 
		/// Only used where it's important to show the month, too.
		/// Month will only show if less than 18yo.
		/// </summary>

...
{
    /// <summary>
    /// You don't generally use this class.
    /// Use Db instead except in special situations.
    /// </summary>
    public class DataCore
	{
		...
		/// <summary>
		/// Generic helper method that executes the func passed in.
		/// 
		/// The ODException will preserve whatever unhandled exception was thrown but will also include the command that was attempted.
		/// </summary>
		public static T ExecuteQueryFunc<T>(Func<T> queryFunc)
		{
            try
			{
				return queryFunc();

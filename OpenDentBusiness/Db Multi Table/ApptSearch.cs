...
namespace OpenDentBusiness
{
	public class ApptSearch
	{
		...
		public static List<ScheduleOpening> GetSearchResults(long aptNum, DateTime dateStart, DateTime dateEnd, List<long> listProvNums, List<long> listOpNums, List<long> listClinicNums, TimeSpan beforeTime, TimeSpan afterTime, long blockoutType = 0, bool hasProvAndBlockout = false, int resultCount = 10)
		{
			...
			SearchBehaviorCriteria searchType = (SearchBehaviorCriteria)PrefC.GetInt(PreferenceName.AppointmentSearchBehavior);
		...
		public static ApptSearchData GetDataForSearch(long aptNum, DateTime dateAfter, DateTime dateBefore, List<long> listProvNums, List<long> listOpNums, List<long> listClinicNums, long blockoutType)
		{
		...
		private static List<ScheduleOpening> FillProviderTimeHelper(List<ApptSearchProviderSchedule> listProvScheds, Appointment appointmentToAdd, DateTime dayEvaluating, long blockoutType)
		{
			//No need to check RemotingRole; no call to db.
	...
	/// <summary>
	/// The information about a single 5 min opening time slot.
	/// A single opening will typically have a provider unless it is a blockout.
	/// </summary>
	[Serializable]
	public class ScheduleOpening
	{
		/// <summary>
		/// The start time of the 5 min opening for this availability.
		/// </summary>
		public DateTime DateTimeAvail = DateTime.MinValue;

		/// <summary>
		/// The provider for this opening.  Can be 0 when this opening is representing a blockout.
		/// </summary>
		public long ProvNum = 0;

		/// <summary>
		/// The clinic this opening was found in (this will be the clinic associated to the operatory).
		/// </summary>
		public long ClinicNum = 0;

		/// <summary>
		/// The operatory this opening is for.  Can be 0 if this opening is a dynamic prov schedule.
		/// </summary>
		public long OpNum = 0;
	}
}

	...
	public class RpOutstandingIns {
		...
		public class OutstandingInsClaim {
			...
			public OutstandingInsClaim(DataRow rowCur) {
				...
				PatDOB=PIn.Date(rowCur["PatDOB"].ToString());
				DateService=PIn.Date(rowCur["DateService"].ToString());
				DateSent=PIn.Date(rowCur["DateSent"].ToString());
				DateOrigSent=PIn.Date(rowCur["DateOrigSent"].ToString());
				...
				DateLog=PIn.Date(rowCur["DateLog"].ToString());
				...
				SubDOB=PIn.Date(rowCur["SubDOB"].ToString());

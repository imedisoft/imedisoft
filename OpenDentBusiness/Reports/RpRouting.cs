...
namespace OpenDentBusiness
{
	...
	{
		/// <summary>
		/// Gets a list of aptNums for one day in the schedule for a given set of providers and clinics.
		/// Will be for all clinics and/or all provs if the corresponding list is null or empty.
		/// </summary>

...
namespace OpenDentBusiness
{
	...
	{
		/// <summary>
		/// Gets a list of unfinalized insurance payments.
		/// </summary>
		...
		/// <summary>
		/// Class that contains a singular unfinalized insurance payment and all relevant information.
		/// Could be a partial payment or a paid claim with no check attached.
		/// </summary>
		public class UnfinalizedInsPay
		{
			...
			public UnfinalizedInsPay(string type, Patient patCur, long clinicNumCur, string carrierCur, DateTime date, DateTime dateOfService, double amt, ClaimPayment claimPay, Claim claim, int countPats)
			{

...
namespace OpenDentBusiness {
	...
	public class MiscDataEvent {
		...
		public static void Fire(EventCategory odEventType,object tag) { Fired?.Invoke(new ODEventArgs(odEventType,tag)); }
	}
	...
	public class CommItemSaveEvent {
		public static event ODEventHandler Fired;
		public static void Fire(EventCategory odEventType,object tag=null) { Fired?.Invoke(new ODEventArgs(odEventType,tag)); }
	}

...
namespace OpenDentBusiness{
	...
	/// Typically, one claim or response. 
	/// Or one benefit request or response. 
	/// Is constantly being expanded to include more types of transactions with clearinghouses. 
	/// Also stores printing of paper claims. 
	/// Sometimes stores a copy of what was sent.
	/// </summary>
	[Table]

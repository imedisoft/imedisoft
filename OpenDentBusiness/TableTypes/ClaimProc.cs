...
namespace OpenDentBusiness{
	...
	public class ClaimProc:TableBase {
		...
		public long PlanNum;
		///<summary>This is the date that is used for payment reports and tracks the payment date. Once a payment has been attached, the DateCP will 
		///exactly match the date of the ClaimPayment it's attached to. See the note under Ledgers.ComputePayments. This will eventually not be used for aging. 
		///The ProcDate will instead be used. See ProcDate.</summary>

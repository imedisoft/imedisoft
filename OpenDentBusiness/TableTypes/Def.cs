...
namespace OpenDentBusiness
{
	...
	/// Almost every table in the database links to definition.
	/// Almost all links to this table will be to a DefNum.
	...
	/// Loaded into memory ahead of time for speed.  Some types of info such as operatories started out life in this table, but then got moved to their own table when more complexity was needed.
	/// </summary>
	[Table("definition")]

...
{
	/// <summary>
	/// This linker table will enable providers to be associated with multiple clinics. 
	/// If a provider does not have an entry in this table, it means that provider is linked to all clinics. 
	/// This is different from the ProviderClinic table. That table holds override information for providers for certain clinics.
	/// </summary>
	[Table]

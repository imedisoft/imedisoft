...
{
    /// <summary>
    /// Simpler than a payment plan. 
    /// Does not affect running account balances. 
    /// Allows override of finance charges. 
    /// Affects the "pay now" on statements. 
    /// Only one installmentplan is allowed for a family, attached to guarantor only. 

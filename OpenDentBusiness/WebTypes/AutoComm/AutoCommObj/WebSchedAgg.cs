...
namespace OpenDentBusiness.AutoComm {
	...
	public class WebSchedAgg:AutoCommObj {
		...
		public WebSchedAgg(WebSchedRecall wsRecall,DateTime dtSend) {
			...
			//These objects already have had the SMSSendStatus and EmailSendStatus set from the database.
			TrySendEmail=(wsRecall.EmailSendStatus==AutoCommStatus.SendNotAttempted);
			TrySendSMS=(wsRecall.SmsSendStatus==AutoCommStatus.SendNotAttempted);

...
namespace OpenDentBusiness {
	...
	public class Patients {
		...
		{
			if(RemotingClient.RemotingRole==RemotingRole.ClientWeb) {
				return Meth.GetTable(MethodBase.GetCurrentMethod(),listPatStatus,doExcludePatsWithFutureAppts,clinicNum,ageFrom,ageTo,dateSeenSince
					,dateNotSeenSince,listBillingType,contactMethod,numDays);
			}
			...
			if(PrefC.HasClinicsEnabled && clinicNum>0) {//greater than 0 for 'All'

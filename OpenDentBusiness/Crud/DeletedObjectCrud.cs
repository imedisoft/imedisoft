...
namespace OpenDentBusiness.Crud{
	public class DeletedObjectCrud {
		...
		public static DeletedObject SelectOne(long deletedObjectNum) {
			...
			List<DeletedObject> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static List<DeletedObject> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				deletedObject.DateTStamp      = PIn.Date (row["DateTStamp"].ToString());
		...
		public static long Insert(DeletedObject deletedObject,bool useExistingPK) {
			...
			if(useExistingPK || PrefC.RandomKeys) {
				...
				deletedObject.DeletedObjectNum=Database.ExecuteInsert(command);
			}

...
namespace OpenDentBusiness.Crud{
	public class SheetFieldCrud {
		...
		public static SheetField SelectOne(long sheetFieldNum) {
			...
			List<SheetField> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static long Insert(SheetField sheetField,bool useExistingPK) {
			...
			var paramFieldValue = new MySqlParameter("paramFieldValue", POut.StringParam(sheetField.FieldValue));
			if(sheetField.UiLabelMobile==null) {
				sheetField.UiLabelMobile="";
			}
			var paramUiLabelMobile = new MySqlParameter("paramUiLabelMobile", POut.StringParam(sheetField.UiLabelMobile));
			if(sheetField.UiLabelMobileRadioButton==null) {
				sheetField.UiLabelMobileRadioButton="";
			}
			var paramUiLabelMobileRadioButton = new MySqlParameter("paramUiLabelMobileRadioButton", POut.StringParam(sheetField.UiLabelMobileRadioButton));
			if(useExistingPK || PrefC.RandomKeys) {
				Database.ExecuteNonQuery(command,paramFieldValue,paramUiLabelMobile,paramUiLabelMobileRadioButton);
			}
			else {
				sheetField.SheetFieldNum=Database.ExecuteInsert(command,paramFieldValue,paramUiLabelMobile,paramUiLabelMobileRadioButton);
			}

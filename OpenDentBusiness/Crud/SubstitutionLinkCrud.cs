...
namespace OpenDentBusiness.Crud{
	public class SubstitutionLinkCrud {
		...
		public static SubstitutionLink SelectOne(long substitutionLinkNum) {
			...
			List<SubstitutionLink> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static List<SubstitutionLink> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				substitutionLink.SubstOnlyIf        = (SubstitutionCondition)PIn.Int(row["SubstOnlyIf"].ToString());
		...
		public static long Insert(SubstitutionLink substitutionLink,bool useExistingPK) {
			...
			if(useExistingPK || PrefC.RandomKeys) {
				...
				substitutionLink.SubstitutionLinkNum=Database.ExecuteInsert(command);
			}

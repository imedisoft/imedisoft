...
namespace OpenDentBusiness.Crud{
	public class ClearinghouseCrud {
		...
		public static Clearinghouse SelectOne(long clearinghouseNum) {
			...
			List<Clearinghouse> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static long Insert(Clearinghouse clearinghouse,bool useExistingPK) {
			...
			var paramExportPath = new MySqlParameter("paramExportPath", POut.StringParam(clearinghouse.ExportPath));

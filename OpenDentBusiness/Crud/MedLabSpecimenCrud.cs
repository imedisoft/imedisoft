...
namespace OpenDentBusiness.Crud
{
	public class MedLabSpecimenCrud
	{
		...
		public static MedLabSpecimen SelectOne(long medLabSpecimenNum)
		{
			...
			List<MedLabSpecimen> list = TableToList(Database.ExecuteDataTable(command));
			if (list.Count == 0)
			{
				return null;
			}
		...
		public static List<MedLabSpecimen> TableToList(DataTable table)
		{
			...
			foreach (DataRow row in table.Rows)
			{
				...
				medLabSpecimen.DateTimeCollected = PIn.Date(row["DateTimeCollected"].ToString());
		...
		public static long Insert(MedLabSpecimen medLabSpecimen, bool useExistingPK)
		{
			...
			{
				medLabSpecimen.MedLabSpecimenNum = Database.ExecuteNonQuery(command);
			}

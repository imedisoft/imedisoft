...
namespace OpenDentBusiness.Crud{
	public class ConfirmationRequestCrud {
		...
		public static ConfirmationRequest SelectOne(long confirmationRequestNum) {
			...
			List<ConfirmationRequest> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static List<ConfirmationRequest> TableToList(DataTable table) {
			...
			foreach(DataRow row in table.Rows) {
				...
				confirmationRequest.DateTimeConfirmExpire   = PIn.Date (row["DateTimeConfirmExpire"].ToString());
				...
				confirmationRequest.DateTimeEntry           = PIn.Date (row["DateTimeEntry"].ToString());
				confirmationRequest.DateTimeConfirmTransmit = PIn.Date (row["DateTimeConfirmTransmit"].ToString());
				confirmationRequest.DateTimeRSVP            = PIn.Date (row["DateTimeRSVP"].ToString());
				...
				confirmationRequest.AptDateTimeOrig         = PIn.Date (row["AptDateTimeOrig"].ToString());
		...
		public static long Insert(ConfirmationRequest confirmationRequest,bool useExistingPK) {
			...
			var paramMsgTextToMobileTemplate = new MySqlParameter("paramMsgTextToMobileTemplate", POut.StringParam(confirmationRequest.MsgTextToMobileTemplate));
			if(confirmationRequest.MsgTextToMobile==null) {
				confirmationRequest.MsgTextToMobile="";
			}
			var paramMsgTextToMobile = new MySqlParameter("paramMsgTextToMobile", POut.StringParam(confirmationRequest.MsgTextToMobile));
			if(confirmationRequest.EmailSubjTemplate==null) {
				confirmationRequest.EmailSubjTemplate="";
			}
			var paramEmailSubjTemplate = new MySqlParameter("paramEmailSubjTemplate", POut.StringParam(confirmationRequest.EmailSubjTemplate));
			if(confirmationRequest.EmailSubj==null) {
				confirmationRequest.EmailSubj="";
			}
			var paramEmailSubj = new MySqlParameter("paramEmailSubj", POut.StringParam(confirmationRequest.EmailSubj));
			if(confirmationRequest.EmailTextTemplate==null) {
				confirmationRequest.EmailTextTemplate="";
			}
			var paramEmailTextTemplate = new MySqlParameter("paramEmailTextTemplate", POut.StringParam(confirmationRequest.EmailTextTemplate));
			if(confirmationRequest.EmailText==null) {
				confirmationRequest.EmailText="";
			}
			var paramEmailText = new MySqlParameter("paramEmailText", POut.StringParam(confirmationRequest.EmailText));
			if(confirmationRequest.ResponseDescript==null) {
				confirmationRequest.ResponseDescript="";
			}
			var paramResponseDescript = new MySqlParameter("paramResponseDescript", POut.StringParam(confirmationRequest.ResponseDescript));
			if(confirmationRequest.GuidMessageToMobile==null) {
				confirmationRequest.GuidMessageToMobile="";
			}
			var paramGuidMessageToMobile = new MySqlParameter("paramGuidMessageToMobile", POut.StringParam(confirmationRequest.GuidMessageToMobile));
			if(confirmationRequest.GuidMessageFromMobile==null) {
				confirmationRequest.GuidMessageFromMobile="";
			}
			var paramGuidMessageFromMobile = new MySqlParameter("paramGuidMessageFromMobile", POut.StringParam(confirmationRequest.GuidMessageFromMobile));
			if(useExistingPK || PrefC.RandomKeys) {
				Database.ExecuteNonQuery(command,paramMsgTextToMobileTemplate,paramMsgTextToMobile,paramEmailSubjTemplate,paramEmailSubj,paramEmailTextTemplate,paramEmailText,paramResponseDescript,paramGuidMessageToMobile,paramGuidMessageFromMobile);
			}
			else {
				confirmationRequest.ConfirmationRequestNum=Database.ExecuteInsert(command,paramMsgTextToMobileTemplate,paramMsgTextToMobile,paramEmailSubjTemplate,paramEmailSubj,paramEmailTextTemplate,paramEmailText,paramResponseDescript,paramGuidMessageToMobile,paramGuidMessageFromMobile);
			}

...
namespace OpenDentBusiness.Crud{
	public class MountItemCrud {
		...
		public static MountItem SelectOne(long mountItemNum) {
			...
			List<MountItem> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static long Insert(MountItem mountItem,bool useExistingPK) {
			...
			command+="MountNum,Xpos,Ypos,ItemOrder,Width,Height) VALUES(";
			if(useExistingPK || PrefC.RandomKeys) {
			...
			if(useExistingPK || PrefC.RandomKeys) {
				...
				mountItem.MountItemNum=Database.ExecuteInsert(command);
			}

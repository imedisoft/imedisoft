...
namespace OpenDentBusiness.Crud{
	public class EmailAutographCrud {
		...
		public static EmailAutograph SelectOne(long emailAutographNum) {
			...
			List<EmailAutograph> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static long Insert(EmailAutograph emailAutograph,bool useExistingPK) {
			...
			var paramDescription = new MySqlParameter("paramDescription", POut.StringParam(emailAutograph.Description));

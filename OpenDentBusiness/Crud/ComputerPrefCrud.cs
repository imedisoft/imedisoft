...
namespace OpenDentBusiness.Crud{
	public class ComputerPrefCrud {
		...
		public static ComputerPref SelectOne(long computerPrefNum) {
			...
			List<ComputerPref> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static long Insert(ComputerPref computerPref,bool useExistingPK) {
			...
			if(useExistingPK || PrefC.RandomKeys) {
				...
				computerPref.ComputerPrefNum=Database.ExecuteInsert(command);
			}

...
namespace OpenDentBusiness.Crud{
	public class EhrTriggerCrud {
		...
		public static EhrTrigger SelectOne(long ehrTriggerNum) {
			...
			List<EhrTrigger> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static long Insert(EhrTrigger ehrTrigger,bool useExistingPK) {
			...
			var paramProblemSnomedList = new MySqlParameter("paramProblemSnomedList", POut.StringParam(ehrTrigger.ProblemSnomedList));
			if(ehrTrigger.ProblemIcd9List==null) {
				ehrTrigger.ProblemIcd9List="";
			}
			var paramProblemIcd9List = new MySqlParameter("paramProblemIcd9List", POut.StringParam(ehrTrigger.ProblemIcd9List));
			if(ehrTrigger.ProblemIcd10List==null) {
				ehrTrigger.ProblemIcd10List="";
			}
			var paramProblemIcd10List = new MySqlParameter("paramProblemIcd10List", POut.StringParam(ehrTrigger.ProblemIcd10List));
			if(ehrTrigger.ProblemDefNumList==null) {
				ehrTrigger.ProblemDefNumList="";
			}
			var paramProblemDefNumList = new MySqlParameter("paramProblemDefNumList", POut.StringParam(ehrTrigger.ProblemDefNumList));
			if(ehrTrigger.MedicationNumList==null) {
				ehrTrigger.MedicationNumList="";
			}
			var paramMedicationNumList = new MySqlParameter("paramMedicationNumList", POut.StringParam(ehrTrigger.MedicationNumList));
			if(ehrTrigger.RxCuiList==null) {
				ehrTrigger.RxCuiList="";
			}
			var paramRxCuiList = new MySqlParameter("paramRxCuiList", POut.StringParam(ehrTrigger.RxCuiList));
			if(ehrTrigger.CvxList==null) {
				ehrTrigger.CvxList="";
			}
			var paramCvxList = new MySqlParameter("paramCvxList", POut.StringParam(ehrTrigger.CvxList));
			if(ehrTrigger.AllergyDefNumList==null) {
				ehrTrigger.AllergyDefNumList="";
			}
			var paramAllergyDefNumList = new MySqlParameter("paramAllergyDefNumList", POut.StringParam(ehrTrigger.AllergyDefNumList));
			if(ehrTrigger.DemographicsList==null) {
				ehrTrigger.DemographicsList="";
			}
			var paramDemographicsList = new MySqlParameter("paramDemographicsList", POut.StringParam(ehrTrigger.DemographicsList));
			if(ehrTrigger.LabLoincList==null) {
				ehrTrigger.LabLoincList="";
			}
			var paramLabLoincList = new MySqlParameter("paramLabLoincList", POut.StringParam(ehrTrigger.LabLoincList));
			if(ehrTrigger.VitalLoincList==null) {
				ehrTrigger.VitalLoincList="";
			}
			var paramVitalLoincList = new MySqlParameter("paramVitalLoincList", POut.StringParam(ehrTrigger.VitalLoincList));
			if(ehrTrigger.Instructions==null) {
				ehrTrigger.Instructions="";
			}
			var paramInstructions = new MySqlParameter("paramInstructions", POut.StringParam(ehrTrigger.Instructions));
			if(ehrTrigger.Bibliography==null) {
				ehrTrigger.Bibliography="";
			}
			var paramBibliography = new MySqlParameter("paramBibliography", POut.StringParam(ehrTrigger.Bibliography));
			if(useExistingPK || PrefC.RandomKeys) {
				Database.ExecuteNonQuery(command,paramProblemSnomedList,paramProblemIcd9List,paramProblemIcd10List,paramProblemDefNumList,paramMedicationNumList,paramRxCuiList,paramCvxList,paramAllergyDefNumList,paramDemographicsList,paramLabLoincList,paramVitalLoincList,paramInstructions,paramBibliography);
			}
			else {
				ehrTrigger.EhrTriggerNum=Database.ExecuteInsert(command,paramProblemSnomedList,paramProblemIcd9List,paramProblemIcd10List,paramProblemDefNumList,paramMedicationNumList,paramRxCuiList,paramCvxList,paramAllergyDefNumList,paramDemographicsList,paramLabLoincList,paramVitalLoincList,paramInstructions,paramBibliography);
			}

...
namespace OpenDentBusiness.Crud{
	public class EmailHostingTemplateCrud {
		...
		public static EmailHostingTemplate SelectOne(long emailHostingTemplateNum) {
			...
			List<EmailHostingTemplate> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static long Insert(EmailHostingTemplate emailHostingTemplate,bool useExistingPK) {
			...
			MySqlParameter paramSubject = new MySqlParameter("paramSubject", POut.StringParam(emailHostingTemplate.Subject));
			if(emailHostingTemplate.BodyPlainText==null) {
				emailHostingTemplate.BodyPlainText="";
			}
			MySqlParameter paramBodyPlainText = new MySqlParameter("paramBodyPlainText", POut.StringParam(emailHostingTemplate.BodyPlainText));
			if(emailHostingTemplate.BodyHTML==null) {
				emailHostingTemplate.BodyHTML="";
			}
			MySqlParameter paramBodyHTML = new MySqlParameter("paramBodyHTML", POut.StringParam(emailHostingTemplate.BodyHTML));
			if(useExistingPK || PrefC.RandomKeys) {
				Database.ExecuteNonQuery(command,paramSubject,paramBodyPlainText,paramBodyHTML);
			}
			else {
				emailHostingTemplate.EmailHostingTemplateNum=Database.ExecuteInsert(command,paramSubject,paramBodyPlainText,paramBodyHTML);
			}
		...
		public static long InsertNoCache(EmailHostingTemplate emailHostingTemplate,bool useExistingPK) {
			...
			var paramSubject = new MySqlParameter("paramSubject", POut.StringParam(emailHostingTemplate.Subject));
			if(emailHostingTemplate.BodyPlainText==null) {
				emailHostingTemplate.BodyPlainText="";
			}
			var paramBodyPlainText = new MySqlParameter("paramBodyPlainText", POut.StringParam(emailHostingTemplate.BodyPlainText));
			if(emailHostingTemplate.BodyHTML==null) {
				emailHostingTemplate.BodyHTML="";
			}
			var paramBodyHTML = new MySqlParameter("paramBodyHTML", POut.StringParam(emailHostingTemplate.BodyHTML));
			if(useExistingPK) {
				Database.ExecuteNonQuery(command,paramSubject,paramBodyPlainText,paramBodyHTML);
			}
			else {

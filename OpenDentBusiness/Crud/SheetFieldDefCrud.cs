...
namespace OpenDentBusiness.Crud{
	public class SheetFieldDefCrud {
		...
		public static SheetFieldDef SelectOne(long sheetFieldDefNum) {
			...
			List<SheetFieldDef> list=TableToList(Database.ExecuteDataTable(command));
			if(list.Count==0) {
				return null;
			}
			return list[0];
		...
		public static long Insert(SheetFieldDef sheetFieldDef,bool useExistingPK) {
			...
			var paramFieldValue = new MySqlParameter("paramFieldValue", POut.StringParam(sheetFieldDef.FieldValue));
			if(sheetFieldDef.UiLabelMobile==null) {
				sheetFieldDef.UiLabelMobile="";
			}
			var paramUiLabelMobile = new MySqlParameter("paramUiLabelMobile", POut.StringParam(sheetFieldDef.UiLabelMobile));
			if(sheetFieldDef.UiLabelMobileRadioButton==null) {
				sheetFieldDef.UiLabelMobileRadioButton="";
			}
			var paramUiLabelMobileRadioButton = new MySqlParameter("paramUiLabelMobileRadioButton", POut.StringParam(sheetFieldDef.UiLabelMobileRadioButton));
			if(useExistingPK || PrefC.RandomKeys) {
				Database.ExecuteNonQuery(command,paramFieldValue,paramUiLabelMobile,paramUiLabelMobileRadioButton);
			}
			else {
				sheetFieldDef.SheetFieldDefNum=Database.ExecuteInsert(command,paramFieldValue,paramUiLabelMobile,paramUiLabelMobileRadioButton);
			}

...
namespace SparksToothChart
{
	...
	public class ToothChartData
	{
		...
		/// <summary>
		/// This also adjusts the result to account for a control that is not the same proportion as the original.
		/// Result could be outside the projection area.
		/// </summary>
		...
		/// <summary>
		/// The recMm has origin at LL. 
		/// The result has origin at UL and is in control coords.
		/// </summary>
		...
		/// <summary>
		/// Input is pixel coordinates of control. 
		/// Always returns a string, 1 through 32 or A through T. 
		/// Primary letters are only returned if that tooth is set as primary.
		/// </summary>
		...
		/// <summary>
		/// Returns a series of points that can be used to create a droplet shape for bleeding and suppuration.
		/// The points form a pentagon with a sixth implied point at 0,0.  Use the points and 0,0 to create 5 triangles.
		/// Coordinates are in mm's.  If the droplet needs to be scaled, that will be done inside this method rather than externally.
		/// The droplet will need to be flipped or rotated about the 0,0 point for use in the mandibular.
		/// </summary>

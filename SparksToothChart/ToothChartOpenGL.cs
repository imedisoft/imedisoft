...
{
	public partial class ToothChartOpenGL : OpenGLWinFormsControl
	{//.SimpleOpenGlControl {
		...
		private void ToothChart_TaoRenderScene(object sender, System.EventArgs e)
		{
			...
			double heightProj = TcData.SizeOriginalProjection.Height;
			double widthProj = TcData.SizeOriginalProjection.Width;
			if (TcData.IsWide)
			{

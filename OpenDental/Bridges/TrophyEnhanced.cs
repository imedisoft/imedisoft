...
{
    public static class TrophyEnhanced
	{
		/// <summary>
		/// Launches the program using command line.
		/// It is confirmed that there is no space after the -P or -N
		/// </summary>
		...
		/// <summary>
		/// Guaranteed to always return a valid foldername unless major error or user chooses to exit. 
		/// This also saves the TrophyFolder value to this patient in the db and creates the new folder.
		/// </summary>
		...
		/// <summary>
		/// Guaranteed to always return a valid foldername unless major error or user chooses to exit.
		/// This also saves the TrophyFolder value to this patient in the db.
		/// </summary>
	...
	{
		/// <summary>
		/// The simple folder name, like G000002, without the .rvg\
		/// </summary>

...
{
    public static class EHG_statements
	{
		//these are temporary:
		...
		/// <summary>
		/// Returns empty list if no errors. Otherwise returns a list with error messages.
		/// </summary>
		...
		/// <summary>
		/// The clinic variable can be null.
		/// </summary>
		...
		/// <summary>
		/// Adds the xml for one statement. Validation is performed here.
		/// Throws an exception if there is a validation failure.
		/// </summary>
		...
		/// The "data" is the previously constructed xml.
		/// If the internet connection is lost or unavailable, then the exception thrown will be a 404 error similar to the following: "The remote server returned an error: (404) Not Found"
		/// </summary>

...
namespace OpenDental.Bridges
{
    ...
    public static class XVWeb
	{
		...
		public static void SendData(Program ProgramCur, Patient pat)
		{
			...
			{
				List<ProgramProperty> listProgramProperties = ProgramProperties.GetForProgram(ProgramCur.Id);
		...
		/// <summary>
		/// Removes ampersands and number symbols.
		/// </summary>
		...
		/// <summary>
		/// Returns if the original POST token has expired or not to know if another one needs to be made.
		/// </summary>
		...
		/// <summary>
		/// Makes a post request to opendental.xvweb and returns a token string that allows access for get requests.
		/// Times out after 5 mins then string is no longer valid and another post will need to be made to get another access token. 
		/// </summary>
		...
		/// <summary>
		/// A GET request that saves XVWeb Image information so we can get an image later on.
		/// </summary>
		...
		/// <summary>
		/// A GET request that returns a bitmap image for XVWeb.
		/// </summary>
		...
		/// <summary>
		/// Saves the image to A to Z in a new document if the program property to save images is set.
		/// Returns null if images are not set to be saved or if the image already exists.
		/// </summary>
		...
		/// <summary>
		/// Get a list of thumbnails for this patient.
		/// </summary>
		...
		/// <summary>
		/// A general GET request helper that accepts JSON and saves it to a string.
		/// </summary>
		...
		private static Stream GetRequestHelperStream(string token, UriBuilder url, bool doRetryIfUnauthorized = true, string contentType = "application/json", string accept = "application/json")
		{
		...
		/// <summary>
		/// Runs all the necessary POST and GET requests for XVWeb and saves the results to a list containing the image information.
		/// </summary>
	...
	/// <summary>
	/// Options for XVWeb image quality.
	/// </summary>

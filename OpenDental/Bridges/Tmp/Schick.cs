...
namespace OpenDental.Bridges
{
    ...
    /// The algorithm provided below was inspired by the Schick example project named CSAutoApp_2008.
    /// </summary>
    public static class Schick
	{
		...
		/// <summary>
		/// Initializes Schick and loads an empty exam.
		/// </summary>
		...
		/// <summary>
		/// When the user clicks OK from the exam window, the patient will be created.
		/// The user can also cancel.
		/// </summary>

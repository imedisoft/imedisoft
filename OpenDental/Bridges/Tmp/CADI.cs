...
namespace OpenDental.Bridges
{
	...
	internal class CADINativeWindow : NativeWindow
	{
		...
		/// <summary>
		/// The comObject used to communicate to CADI
		/// </summary>
        ...
        /// <summary>
        /// Event will be raised anytime this instance closes. Alerts owner to release reference to this instance.
        /// </summary>
		...
		public void SendData(Program ProgramCur, Patient pat)
		{
			try
			{
				...
				string id = "";
				if (ProgramProperties.GetPropVal(ProgramCur.Id, ProgramProperties.PropertyDescs.PatOrChartNum) == "0")
				{
				...
				string imagePath = ProgramProperties.GetPropVal(ProgramCur.Id, ProgramProperties.PropertyDescs.ImageFolder);
		...
		{
			ODException.SwallowAnyException(() => { ReleaseHandle(); });

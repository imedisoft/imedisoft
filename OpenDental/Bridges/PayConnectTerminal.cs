...
{
    /// <summary>
    /// Methods that can be used when interacting with a PayConnect terminal.
    /// </summary>
    public static class PayConnectTerminal
	{
		/// <summary>
		/// Builds a receipt string for a terminal transaction.
		/// </summary>
		...
		/// <summary>
		/// Returns the field name and value formatted to be added to a receipt string. 
		/// The fieldName should be less than 15 characters.
		/// </summary>
		...
		/// <summary>
		/// Turns a PosResponse into an OpenDentBusiness.PayConnectResponse.
		/// </summary>

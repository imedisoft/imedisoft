...
namespace OpenDental{
	...
	public class FormImportXML : ODForm {
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			if(textMain.Text==""){
				MessageBox.Show("Please paste the text generated by the other program into the large box first.");
				return;
			}
			pat=new Patient();
			...
			subsc=new Patient();
			subsc.PriProv=Preferences.GetLong(PreferenceName.PracticeDefaultProv);
			subsc.BillingType=Preferences.GetLong(PreferenceName.PracticeDefaultBillType);
			sub=new InsSub();
			...
			try{
				...
				//MessageBox.Show("Error in the XML format.");
				reader.Close();
				return;
			}
			finally{
			...
			if(pat.LName=="" || pat.FName=="" || pat.Birthdate.Year<1880){
				MessageBox.Show("Patient first and last name and birthdate are required.  Could not import.");
				return;
			}

	...
	public class FormFeeSchedEdit:ODForm {
		...
		private void checkIsHidden_Click(object sender,EventArgs e) {
			...
			if(providersUsingFee!="") {
				MessageBox.Show("Cannot hide. Fee schedule is currently in use by the following providers"+":\r\n"+providersUsingFee);
				checkIsHidden.Checked=false;
			}
			string patsUsingFee="";
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			else if(isGlobalOld!=FeeSchedCur.IsGlobal) {
				log="Edited Fee Schedule \""+textDescription.Text+"\": Changed \"Use Headquarter's Fees\" from ";
				if(isGlobalOld) {
					log+="Checked ";
				}
				else {

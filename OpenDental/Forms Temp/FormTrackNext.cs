...
namespace OpenDental{
	...
	public class FormTrackNext : ODForm {
		...
		private void InitDateRange() {
			int dayCount=PrefC.GetInt(PreferenceName.PlannedApptDaysPast);
			dateRangePicker.SetDateTimeFrom(DateTime.Today.AddDays(-dayCount));
			dayCount=PrefC.GetInt(PreferenceName.PlannedApptDaysFuture);
		...
		private void FillGrid(){
			ODProgress.ShowAction(//Show progress window while filling the grid.
				...
				startingMessage:"Filling the Planned Appointments Grid...",
		...
		private void butPrint_Click(object sender,EventArgs e) {
			...
			PrinterL.TryPrintOrDebugRpPreview(pd_PrintPage,"Planned appointment tracker list printed");
		}
		...
		private void pd_PrintPage(object sender,System.Drawing.Printing.PrintPageEventArgs e) {
			...
			#region printHeading
			if(!headingPrinted) {
				text="Planned Appointment Tracker";

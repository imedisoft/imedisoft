...
namespace OpenDental{
    ...
    public bool IsNew;
		...
		private void butDetach_Click(object sender,EventArgs e) {
			...
			if(!MsgBox.Show(MsgBoxButtons.YesNo,"Detach Referral?")) {
				return;
			}
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			if((ReferralType)listRefType.SelectedIndex==ReferralType.RefTo && Preferences.GetBool(PreferenceName.ShowFeatureEhr)) {
				string warning="";

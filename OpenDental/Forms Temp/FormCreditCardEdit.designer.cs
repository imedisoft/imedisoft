namespace OpenDental{
	partial class FormCreditCardEdit {
		...
		private void InitializeComponent() {
			...
			this.comboPaymentType = new OpenDental.UI.ComboBoxPlus();
			...
			// textAccountType
			// 
			this.textAccountType.Location = new System.Drawing.Point(301, 39);
			...
			// labelAcctType
			// 
			this.labelAcctType.Location = new System.Drawing.Point(213, 40);
    ...
    "these values if no further recurring charges are planned.";
		...
		private UI.ComboBoxPlus comboPaymentType;

...
namespace OpenDental {
	...
	public class FormASAP:ODForm {
		...
		private void InitializeComponent() {
            ...
            this.butClose.Location = new System.Drawing.Point(967, 555);
            ...
            this.butPrint.Location = new System.Drawing.Point(967, 464);
            ...
            this.splitContainer.Size = new System.Drawing.Size(920, 537);
		...
		private void SendWebSched() {
			...
			{//No clinics are signed up for Web Sched
				string message = PrefC.HasClinicsEnabled ?
					"No clinics are signed up for Web Sched ASAP." :
					"This practice is not signed up for Web Sched ASAP";
			...
			if(!isSignedUp) {
				MessageBox.Show("The clinic the selected operatory belongs to is not signed up for Web Sched ASAP.");

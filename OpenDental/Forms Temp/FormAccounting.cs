...
namespace OpenDental{
	...
	public class FormAccounting:ODForm {
		...
		private MenuItem menuItemProfitLoss;
		...
		private void InitializeComponent()
		{
            ...
            this.menuItemProfitLoss.Click += new System.EventHandler(this.menuItemProfitLoss_Click);
            // 
            // labelDate
            // 
		...
		public void LayoutToolBar() {
			...
			ToolBarMain.Buttons.Add(new ODToolBarButton("Add",0,"","Add"));
			...
			ToolBarMain.Buttons.Add(new ODToolBarButton(ODToolBarButtonStyle.Separator));*/
			ToolBarMain.Buttons.Add(new ODToolBarButton("Export",2,"Export the Chart of Accounts","Export"));
		...
		private void menuItemProfitLoss_Click(object sender, EventArgs e){
			FormRpAccountingProfitLoss formRpAccountingProfitLoss=new FormRpAccountingProfitLoss();
		...
		private void FillGrid(){
			...
			gridMain.ListGridColumns.Add(col);
			col=new GridColumn("Balance",80,HorizontalAlignment.Right);
			gridMain.ListGridColumns.Add(col);
			col=new GridColumn("Bank Number",100);
			gridMain.ListGridColumns.Add(col);
			col=new GridColumn("Inactive",70,HorizontalAlignment.Center);
			gridMain.ListGridColumns.Add(col);

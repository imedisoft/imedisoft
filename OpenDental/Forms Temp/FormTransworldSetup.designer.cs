namespace OpenDental{
	partial class FormTransworldSetup {
		...
		private void InitializeComponent() {
			...
			this.comboNegAdjType = new OpenDental.UI.ComboBoxPlus();
			this.comboPosAdjType = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboPaidInFullBillType = new OpenDental.UI.ComboBoxPlus();
			...
			this.comboClinic.Location = new System.Drawing.Point(142, 76);

...
namespace OpenDental {
	public partial class FormPatientAddAll:ODForm {
		...
		private void FormPatientAddAll_Load(object sender, EventArgs e)
		{
			...
			else if (Preferences.GetBool(PreferenceName.ClinicAllowPatientsAtHeadquarters))
			{
		...
		private void butOK_Click(object sender,EventArgs e) {
			...
			if(PrefC.HasClinicsEnabled && !Preferences.GetBool(PreferenceName.ClinicAllowPatientsAtHeadquarters)) {
			...
			Patient pat=new Patient();
			pat.BillingType=Preferences.GetLong(PreferenceName.PracticeDefaultBillType);
			...
			if(insComplete1) {
				...
				if(selectedPlan1==null) {
					...
					if(selectedPlan1.PlanType=="" && Preferences.GetBool(PreferenceName.InsDefaultShowUCRonClaims)) {
			...
			if(insComplete2) {
				...
				if(selectedPlan2==null) {
					...
					if(selectedPlan2.PlanType=="" && Preferences.GetBool(PreferenceName.InsDefaultShowUCRonClaims)) {

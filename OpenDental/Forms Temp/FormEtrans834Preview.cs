	...
	public partial class FormEtrans834Preview:ODForm {
		...
		private bool TryImport834() {
			...
			if(createdPatsCount > 0) {
				msg+="\r\n"+"Number of patients created:"+" "+createdPatsCount;
			}
			if(updatedPatsCount > 0) {
				msg+="\r\n"+"Number of patients updated:"+" "+updatedPatsCount;
			}
			if(skippedPatsCount > 0) {
				msg+="\r\n"+"Number of patients skipped:"+" "+skippedPatsCount;
				msg+=sbErrorMessages.ToString();
			}
			if(createdCarrierCount > 0) {
				msg+="\r\n"+"Number of carriers created:"+" "+createdCarrierCount;
				msg+=sbErrorMessages.ToString();
			}
			if(createdInsPlanCount > 0) {
				msg+="\r\n"+"Number of insurance plans created:"+" "+createdInsPlanCount;
				msg+=sbErrorMessages.ToString();
			}
			if(updatedInsPlanCount > 0) {
				msg+="\r\n"+"Number of insurance plan updates:"+" "+updatedInsPlanCount;
				msg+=sbErrorMessages.ToString();
			}
			if(createdInsSubCount > 0) {
				msg+="\r\n"+"Number of insurance subscriptions created:"+" "+createdInsSubCount;
				msg+=sbErrorMessages.ToString();
			}
			if(updatedInsSubCount > 0) {
				msg+="\r\n"+"Number of insurance subscriptions updated:"+" "+updatedInsSubCount;
				msg+=sbErrorMessages.ToString();
			}
			if(createdPatPlanCount > 0) {
				msg+="\r\n"+"Number of patients added to insurance:"+" "+createdPatPlanCount;
				msg+=sbErrorMessages.ToString();
			}
			if(droppedPatPlanCount > 0) {
				msg+="\r\n"+"Number of patients dropped from insurance:"+" "+droppedPatPlanCount;
				msg+=sbErrorMessages.ToString();
			}
			if(updatedPatPlanCount > 0) {
				msg+="\r\n"+"Number of patients insurance information updated:"+" "+updatedPatPlanCount;
				msg+=sbErrorMessages.ToString();
			}

...
namespace OpenDental{
	...
	public partial class FormPerio : ODForm {
        ...
        "  Used to input positive gingival margins (hyperplasia).");
			...
			// butCalculus
			// 
			this.butCalculus.Location = new System.Drawing.Point(778, 272);
			...
			// butPlaque
			// 
			this.butPlaque.Location = new System.Drawing.Point(778, 242);
			...
			// butPus
			// 
			this.butPus.Location = new System.Drawing.Point(778, 332);
			...
			// butBleed
			// 
			this.butBleed.Location = new System.Drawing.Point(778, 302);
		...
		private void butListen_Click(object sender,EventArgs e) {
			...
			try {
				...
				FriendlyException.Show("Unable to initialize audio input. Try plugging a different microphone into the computer.",ex);
			}
		}
		...
		private void butPrint_Click(object sender, System.EventArgs e) {
			...
			PrinterL.TryPrint(pd2_PrintPage,
				"Perio chart from"+" "+PerioExamCur.ExamDate+" "+"printed",
				PatCur.PatNum,
		...
		private void butSave_Click(object sender,EventArgs e) {
			...
			string titleStr="Periodontal Charting";

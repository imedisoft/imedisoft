...
namespace OpenDental {
	public partial class FormOrthoCase:ODForm {
		...
		private void ButAddBandingProcedure_Click(object sender,EventArgs e) {
			FormProcBandingSelect formProcBandingSelect=new FormProcBandingSelect(_patCur.PatNum);
		...
		private void ButPatPayPlan_Click(object sender,EventArgs e) {
			...
			FormPayPlanDynamic formPayPlanDynamic=new FormPayPlanDynamic(_patPayPlan,false,_listAllCompletedProcs);
		...
		private void CreateNewPayPlan() {
			...
			_patPayPlan.PayPlanDate=DateTimeOD.Today;
		...
		private void ButOK_Click(object sender,EventArgs e) {
			...
			if(_isNew) {
				...
				newOrthoCase.SecUserNumEntry=Security.CurrentUser.Id;
				...
				newOrthoSchedulePlanLink.SecUserNumEntry=Security.CurrentUser.Id;
			...
			if(_patPayPlan!=null && _orthoPlanLinkPatPayPlan==null) {
				...
				_orthoPlanLinkPatPayPlan.SecUserNumEntry=Security.CurrentUser.Id;

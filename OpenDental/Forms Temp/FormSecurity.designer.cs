namespace OpenDental{
	partial class FormSecurity {
		...
		private void InitializeComponent() {
			...
			this.userControlSecurityTabs.CopyUserClick += new OpenDental.UserControlSecurityUserGroup.SecurityTabsEventHandler(this.UserControlSecurityTabs_CopyUserClick);

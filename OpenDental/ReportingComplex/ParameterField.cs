...
namespace OpenDental.ReportingComplex
{
    ...
    public class ParameterField
	{
		...
		public ParameterField(string thisName, FieldValueType thisValueType, object thisDefaultValue, string thisPromptingText, string thisSnippet)
		{
			...
			defCategory = DefinitionCategory.AccountColors;//arbitrary
		...
		/// <summary>
		/// Overload for ValueKind DefinitionCategory.
		/// </summary>
		public ParameterField(string thisName, FieldValueType thisValueType, ArrayList theseDefaultValues, string thisPromptingText, string thisSnippet, string thisDefCategory)
		{
			name = thisName;
			valueType = thisValueType;
			defaultValues = theseDefaultValues;
		...
		/// The entire output value is surrounded by parentheses.
		/// </summary>

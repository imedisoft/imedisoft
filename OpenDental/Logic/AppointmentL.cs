    ...
    public class AppointmentL
	{
		...
		public static void BreakApptHelper(Appointment appt, Patient pat, ProcedureCode procCode)
		{
			...
			if (procCode != null)
			{
				...
				{//PPO
					double provFee = Fees.GetAmount0(brokenProcedure.CodeNum, Providers.GetById(brokenProcedure.ProvNum).FeeScheduleId, brokenProcedure.ClinicNum,
			...
			if (Preferences.GetBool(PreferenceName.BrokenApptCommLog))
			{
                Commlog commlogCur = new Commlog
                {
                    ...
                    Note = "Appt BROKEN for" + " " + appt.ProcDescript + "  " + appt.AptDateTime.ToString(),

	...
	public partial class FormRpInsPayPlansPastDue:ODForm {
      ...
      return true;
		...
		private void butPrint_Click(object sender,EventArgs e) {
			...
			PrinterL.TryPrintOrDebugRpPreview(pd_PrintPage,"Outstanding insurance report printed");
		}
		...
		private void pd_PrintPage(object sender,System.Drawing.Printing.PrintPageEventArgs e) {
			...
			#region printHeading
			if(!_headingPrinted) {
				text="Outstanding Insurance Payment Plans";
		...
		private void butExport_Click(object sender,System.EventArgs e) {			
			string fileName="Outstanding Insurance Payment Plans";

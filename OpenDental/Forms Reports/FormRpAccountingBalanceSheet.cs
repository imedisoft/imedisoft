...
///<summary></summary>
	public class FormRpAccountingBalanceSheet:ODForm {
		...
		private void butOK_Click(object sender, System.EventArgs e) {
			...
			reportComplex.AddTitle("Title","Balance Sheet",fontTitle);
			reportComplex.AddSubTitle("PracName",Preferences.GetString(PreferenceName.PracticeTitle),fontSubTitle);

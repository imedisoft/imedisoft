...
namespace OpenDental
{
    public partial class FormScheduledProcessesEdit : ODForm
	{
		...
		{
			if (!_schedProcOld.IsNew)
			{
				var result = MessageBox.Show(this,
					"This will delete the currently selected Scheduled Process. Continue?",
					"Delete Scheduled Process.", MessageBoxButtons.OKCancel, MessageBoxIcon.Question);

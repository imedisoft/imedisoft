namespace OpenDental{
	partial class FormSupplyOrders {
		...
		private void InitializeComponent() {
			...
			// gridItems
			// 
			this.gridItems.AddButtonEnabled = true;
			...
			// gridOrders
			// 
			this.gridOrders.AddButtonEnabled = true;
			...
			// butAddSupply
			// 
			this.butAddSupply.Image = global::Imedisoft.Properties.Resources.Add;
			...
			// butNewOrder
			// 
			this.butNewOrder.Image = global::Imedisoft.Properties.Resources.Add;

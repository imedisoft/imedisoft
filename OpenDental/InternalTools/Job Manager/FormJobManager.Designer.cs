namespace OpenDental {
	partial class FormJobManager {
		...
		private void InitializeComponent() {
			...
			this.gridMarketing = new OpenDental.UI.ODGrid();
			...
			this.splitContainer1.Panel2.Controls.Add(this.userControlMarketingEdit);
			...
			this.gridJobsOnHold.Size = new System.Drawing.Size(349, 687);
			...
			this.tabTree.Location = new System.Drawing.Point(4, 76);
			this.tabTree.Name = "tabTree";
			this.tabTree.Padding = new System.Windows.Forms.Padding(3);
			this.tabTree.Size = new System.Drawing.Size(349, 687);
			...
			this.treeJobs.Size = new System.Drawing.Size(347, 581);
			...
			this.userControlMarketingEdit.Size = new System.Drawing.Size(1158, 767);
			this.userControlMarketingEdit.TabIndex = 2;
			this.userControlMarketingEdit.Visible = false;
			this.userControlMarketingEdit.SaveClick += new System.EventHandler(this.userControlMarketingEdit_SaveClick);
			this.userControlMarketingEdit.RequestJob += new OpenDental.InternalTools.Job_Manager.UserControlMarketingEdit.RequestJobEvent(this.userControlJobEdit_RequestJob);
			// 
			// label5
			// 
			...
			this.jobTimeHelperToolStripMenuItem.Visible = false;
		...
		private UI.ODGrid gridMarketing;
		...
		private InternalTools.Job_Manager.UserControlMarketingEdit userControlMarketingEdit;
	}
}
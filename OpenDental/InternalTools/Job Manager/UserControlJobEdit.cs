...
namespace OpenDental.InternalTools.Job_Manager {
	...
	public partial class UserControlJobEdit:UserControl {
		...
		private bool ValidateJob(Job _jobCur) {
			...
			if(!_jobCur.Category.In(JobCategory.Bug,JobCategory.Query,JobCategory.MarketingDesign) 
		...
		public void actionMenu_ImplementedClick(object sender,EventArgs e) {
			...
			{
				InputBox inBoxDocumentation = new InputBox("Please add a brief description of the job for documentation (including simple step by step usage instructions).",true);

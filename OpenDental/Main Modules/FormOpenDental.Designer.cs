...
namespace OpenDental{
	partial class FormOpenDental{
		...
		private void InitializeComponent(){
			...
			this.menuItemSensors.Visible = false;//Temporarily disabled until event handler is fully functional
			...
			// 
			this.menuItemPendingPayments.Index = 21;
			...
			// menuItemScreening
			// 
			this.menuItemScreening.Index = 22;
			...
			// 
			this.menuItemRepeatingCharges.Index = 23;
			...
			// menuItemResellers
			// 
			this.menuItemResellers.Index = 24;
			...
			// menuItemMassEmails
			// 
			this.menuItemMassEmails.Index = 25;
			...
			// menuItemSetupWizard
			// 
			this.menuItemSetupWizard.Index = 26;
			...
			// menuItemReqStudents
			// 
			this.menuItemReqStudents.Index = 27;
			...
			// menuItemWebForms
			// 
			this.menuItemWebForms.Index = 28;
			...
			this.panelPhoneSmall.Size = new System.Drawing.Size(213, 467);
		...
		private MenuItem menuItemRepeatingCharges;
		...
		private MenuItem menuItemImaging;
		...
		private MenuItem menuItemScanning;
		...
		private MenuItem menuItemMounts;
		private MenuItem menuItemSensors;
		private MenuItem menuItemMergeImageCat;
		private MenuItem menuItemMassEmails;
		private MenuItem menuItemCloudManagement;
	}
}

namespace OpenDental {
	partial class ContrAppt {
		...
		private void InitializeComponent() {
			...
			// gridWaiting
			// 
			this.gridWaiting.AddButtonEnabled = true;
			...
			// gridEmpSched
			// 
			this.gridEmpSched.AddButtonEnabled = true;
			...
			// gridProv
			// 
			this.gridProv.AddButtonEnabled = true;
			...
			// gridReminders
			// 
			this.gridReminders.AddButtonEnabled = true;

...
namespace OpenDental.UI.Voice
{
    public class VoiceController : IDisposable
	{
		...
		/// <summary>
		/// True if the controller is listening for audio input.
		/// </summary>
		public bool IsListening { get; private set; }
		
		/// <summary>
		/// The mimimum level of confidence the recognizer must have to act upon audio input.
		/// </summary>
		public double ConfidenceThreshold = 0.9;
		
		/// <summary>
		/// Event is fired when the speech is recognized.
		/// </summary>
		public event ODSpeechRecognizedEventHandler SpeechRecognized = null;

		/// <summary>
		/// The list of commands that this controller is listening for.
		/// </summary>
		private readonly List<VoiceCommand> _listCommands;

		/// <summary>
		/// True if the controller will give verbal feedback.
		/// </summary>
		private bool _isGivingFeedback;

		/// <summary>
		/// Throws an exception of unable to find a suitable microphone.
		/// </summary>
		...
		/// <summary>
		/// This methods sets the controller to accept audio input.
		/// </summary>
		public void StartListening() 
			=> IsListening = true;

		/// <summary>
		/// This methods sets the controller to not accept audio input.
		/// </summary>

...
namespace OpenDental.UI
{
    ...
    /// <summary>
	/// A combobox used extensively in OD.  Use ComboBoxClinicPicker for Clinics.
	/// This supports multi-select or single-select.  It stores objects, paired with their display strings.
	/// It has special handling for Providers, Defs, and Enums. It handles setting to a value that is not in the list.
	/// It has a special "All" setting.  Providers and Defs have special handling for key=0, but other types have less support.
	/// You can manually add a none/0 item to any combo.  See the bottom of this file for examples of how to use.
	/// </summary>
    public partial class ComboBoxPlus : Control
	{
		...
		protected override void OnKeyDown(KeyEventArgs e)
		{
			...
			if (char.IsLetter((char)e.KeyCode) && !SelectionModeMulti)

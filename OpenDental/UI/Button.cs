...
namespace OpenDental.UI {
	...
	public partial class Button : System.Windows.Forms.Button {
		...
		private void DrawTextAndImage(Graphics g) {
			...
			Size sizeScaled=new Size(Dpi.Scale(this,Image.Width),Dpi.Scale(this,Image.Height));
			...
			if(this.Enabled) {
				g.DrawImage(this.Image,pointImage.X,pointImage.Y,sizeScaled.Width,sizeScaled.Height);
			}
			else {
				...
				g.DrawImage(bitmapDisabled,pointImage.X,pointImage.Y,sizeScaled.Width,sizeScaled.Height);
				gfx.Dispose();

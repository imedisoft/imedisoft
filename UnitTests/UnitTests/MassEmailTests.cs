...
namespace UnitTests.MassEmail_Tests {
	...
	public class MassEmailTests:TestBase {
		...
		public static void SetupClass(TestContext testContext) {
			...
			Patient pat=PatientT.CreatePatient(fName:"Ella",lName:"Vader",contactMethod:ContactMethod.None,patStatus:PatientStatus.Prospective
			...
			pat=PatientT.CreatePatient(fName:"Pepper",lName:"Tony",contactMethod:ContactMethod.None,patStatus:PatientStatus.Inactive
			...
			pat=PatientT.CreatePatient(fName:"Mike",lName:"Rophone",contactMethod:ContactMethod.None,patStatus:PatientStatus.NonPatient
				,birthDate:new DateTime(1957,4,19));
			//Patient with both previous and upcoming
			pat=PatientT.CreatePatient(fName:"Linda",lName:"Zee",contactMethod:ContactMethod.None,patStatus:PatientStatus.Patient
			...
			pat=PatientT.CreatePatient(fName:"Jerry",lName:"Attric",contactMethod:ContactMethod.Email,patStatus:PatientStatus.Patient
			...
			pat=PatientT.CreatePatient(fName:"Ken",lName:"Tucky",contactMethod:ContactMethod.HmPhone,patStatus:PatientStatus.Patient
			...
			pat=PatientT.CreatePatient(fName:"Ana",lName:"Gram",contactMethod:ContactMethod.Email,patStatus:PatientStatus.Patient,
		...
		public void Patients_GetPatientsWithFirstLastAppointment_TableReturnedIsCorrectNoFilters() {
			...
			DataTable table=Patients.GetPatientsWithFirstLastAppointments(_listPatStatus,_doExcludePatsWithFutureAppts,_clinicNum,
				0,110,DateTime.MinValue,DateTime.MinValue,new List<Def>(),_preferredContactMethod,_numDays);
			List<FormMassEmail.PatientInfo> listPatInfo=FormMassEmail.PatientInfo.GetListPatientInfos(table);
		...
		public void Patients_GetPatientsWithFirstLastAppointment_TableReturnedIsCorrectForExcludingRecentEmails() {
			...
			Patient pat1=PatientT.CreatePatient(fName:"Jan",lName:"Yuari",contactMethod:ContactMethod.None,patStatus:PatientStatus.Patient,
			...
			Patient pat2=PatientT.CreatePatient(fName:"Cat",lName:"Astrophy",contactMethod:ContactMethod.None,patStatus:PatientStatus.Patient,
		...
		[TestMethod]
		public void Patients_GetPatientsWithFirstLastAppointments_TableReturnsCorrectSeenSince() {
			DataTable table=Patients.GetPatientsWithFirstLastAppointments(_listPatStatus,_doExcludePatsWithFutureAppts,_clinicNum,
			 0,110,DateTime.Today.AddMonths(-7),DateTime.MinValue,new List<Def>());
			List<FormMassEmail.PatientInfo> listPatInfo=FormMassEmail.PatientInfo.GetListPatientInfos(table);
			Assert.IsTrue(listPatInfo.Count>0);
			Assert.IsTrue(listPatInfo.Exists(x => x.Name=="Tucky, Ken"));
		}

		[TestMethod]
		public void Patients_GetPatientsWithFirstLastAppointments_TableReturnsCorrectNotSeenSince() {
			DataTable table=Patients.GetPatientsWithFirstLastAppointments(_listPatStatus,_doExcludePatsWithFutureAppts,_clinicNum,
			 0,110,DateTime.MinValue,DateTime.Today.AddYears(-1).AddDays(+1),new List<Def>());
			List<FormMassEmail.PatientInfo> listPatInfo=FormMassEmail.PatientInfo.GetListPatientInfos(table);
			Assert.IsTrue(listPatInfo.Count>0);
		...
		[TestMethod]
		public void Patients_GetPatientsWithFirstLastAppointments_TableReturnsCorrectNotSeenAndSeenSince() {
			DataTable table=Patients.GetPatientsWithFirstLastAppointments(_listPatStatus,_doExcludePatsWithFutureAppts,_clinicNum,
			 0,110,DateTime.Today.AddMonths(-7),DateTime.Today.AddYears(-1).AddDays(-1),new List<Def>());
			List<FormMassEmail.PatientInfo> listPatInfo=FormMassEmail.PatientInfo.GetListPatientInfos(table);
			Assert.IsTrue(listPatInfo.Count>0);
			Assert.IsTrue(listPatInfo.Exists(x => x.Name=="Zee, Linda"));
		}
		...
		public void Patients_GetPatientsWithFirstLastAppointments_TableReturnsCorrectBillingType() {
			Patient pat=PatientT.CreatePatient(fName:"Jane",lName:"Doe",contactMethod:ContactMethod.None,patStatus:PatientStatus.Patient,
				birthDate:new DateTime(1996,10,13));
